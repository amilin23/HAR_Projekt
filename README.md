...
This project includes preprocessing, sliding-window dataset generation, Bidirectional LSTM training, multiple evaluation strategies, and inference for activity timeline prediction.
